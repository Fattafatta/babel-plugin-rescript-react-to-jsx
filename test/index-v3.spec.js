...
describe("createElement-to-JSX", () => {
  it("should support all ReScript function calls", () => {
    ...
    expect('ReactDOM.createElement("h1")').to.convertTo("<h1 />;");
    expect('ReactDOMRe.createElement("h1")').to.convertTo("<h1 />;");
    expect('ReactDOMRe.createDOMElementVariadic("h1")').to.convertTo("<h1 />;");
    expect('ReactDOM.createDOMElementVariadic("h1")').to.convertTo("<h1 />;");
    expect('React.createElementVariadic("h1")').to.convertTo("<h1 />;");
  });
  ...
  it("should handle props without children", () => {
    expect('React.createElement("h1", {hi: there})').to.convertTo(
      "<h1 hi={there} />;"
    );
    expect('React.createElement("h2", {"hi": there})').to.convertTo(
      "<h2 hi={there} />;"
    );
    expect('React.createElement("h3", {hi: "there"})').to.convertTo(
      '<h3 hi="there" />;'
    );
  });

  it("should handle spread props", () => {
    expect('React.createElement("h1", props)').to.convertTo(
      "<h1 {...props} />;"
    );
    expect('React.createElement("h1", getProps())').to.convertTo(
      "<h1 {...getProps()} />;"
    );
  });
  ...
  it("should handle mixed props", () => {
    ...
    expect('React.createElement("h1", { ...props, hi: "there" })').to.convertTo(
      '<h1 {...props} hi="there" />;'
    );
  });
